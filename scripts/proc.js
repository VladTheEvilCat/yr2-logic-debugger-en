				...
				if (this.yr2Setting.table.vars) {
					t.table(null, tt => {
						tt.table(null, ttt => {
							...
							}).size(40).tooltip('Analysis?').get().update(() => {
